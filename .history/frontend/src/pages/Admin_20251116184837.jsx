    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                <div className="p-4 bg-green-500 rounded-xl shadow flex items-center justify-between">
                    <div>
                ...
                <div className="p-4 bg-blue-500 rounded-xl shadow flex items-center justify-between">
                    <div>
