                                    ...
                                    >
                                        ...
                                        <td className="p-3 text-center space-x-2">
                                            ...
                                            <button
                                                ...
                                                className="px-3 py-1.5 bg-red-600 text-white text-sm rounded-lg hover:bg-red-700 transition btn btn-red"
                                            >
                                                Delete
                                            </button>
                                        </td>
...
function StatCard({ icon, title, value, color }) {
    return (
        <motion.div
            ...
            className="bg-green-950 rounded-xl shadow-md p-5 flex items-center justify-between border border-gray-100 hover:shadow-lg transition"
        >
            <div>
