...
export default function Navbar() {
    ...
    return (
        <nav className="bg-green-800 text-white px-20 py-10 shadow-md flex flex-wrap gap-50 items-center">
                ...
                <div className="flex flex-wrap items-center gap-50 text-sm md:text-base">
                    ...
                    {!user && (
                        <>
                            <Link
                                to="/login"
                                className="hover:text-gray-200 transition px-4 py-1.5"
                            >
                                Login
                            </Link>
                            <Link
                    ...
                    {user && (
                        <>
                            <Link
                                to="/"
                                className="bg-green-800 hover:text-gray-200 transition px-4 py-1.5"
                            >
                                Dashboard
                            </Link>
                            ...
                            <Link
                                to="/chats"
                                className="hover:text-gray-200 px-4 py-1.5 transition"
                            >
                                Chat
                            </Link>
