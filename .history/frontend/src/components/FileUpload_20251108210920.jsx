            ...
            {preview && (
                <div className="mt-2 p-2 bg-white rounded shadow-sm flex items-center gap-2">
                    {preview.type.startsWith('image/') ? (
                        ...
                        <video src={preview.url} className="w-24 h-16 object-cover" />
                    ) : preview.type.startsWith('audio/') ? (
                        <div className="w-24"><audio controls src={preview.url} /></div>
                    ) : (
                        <div className="w-16 h-16 flex items-center justify-center bg-gray-100 rounded">FILE</div>
                    )}
