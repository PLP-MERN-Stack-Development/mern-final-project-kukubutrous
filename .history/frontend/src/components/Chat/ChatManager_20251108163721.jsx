...
export default function ChatManager({ chats, sendMessage }) {
    ...
    return (
        <>
            ...
            <div
                className={`fixed bottom-0 left-0 right-0 flex gap-2 p-2 bg-gray-100 dark:bg-gray-800 shadow-lg z-50 transition-transform duration-500 ${minimizedChats.length === 0 ? "translate-y-full" : "translate-y-0"
                    }`}
            >
