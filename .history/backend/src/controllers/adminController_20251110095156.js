...
import User from "../models/User.js";//justed
import Chat from "../models/Chat.js";//just added
import Message from "../models/Message.js";//just added
...
export async function updateUserRole(req, res) {
    try {
        ...
        try {
            getIo().emit('admin_user_update', { action: 'role_changed', user: { id: user.id, role: user.role } });
        } catch (e) { }
...
export async function deleteUser(req, res) {
    try {
        ...
        try {
            getIo().emit('admin_user_update', { action: 'deleted', user: { id } });
        } catch (e) { }
...
export async function getDashboardStats(req, res) {
    try {
        ...
        return res.json({ totalUsers, verifiedUsers, totalChats, totalMessages });
    } catch (err) {
