...
export async function register(req, res) {
    try {
        ...
        res.status(201).json({ message: 'Registered successfully. Please verify your email before logging in.' });
    } catch (err) {
...
export async function requestPasswordReset(req, res) {
    try {
        ...
        res.json({ message: 'Reset link sent to your email (if account exists).' });
    } catch (err) {
...
import User from '../models/User.js';
import { sendVerificationEmail, sendResetPasswordEmail } from '../services/emailService.js';
import { signJwt } from '../utils/generateTokens.js';  // ✅ Fixed import
import { getIo } from '../utils/io.js';
